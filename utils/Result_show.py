...
def ReconSR(model,bin,predict_size,step,gap,imagedata_dir,imageedge_dir,savedir,FilenameSave,imagetypeSave):
    ...
    FilenameSave2 = os.path.split(imagedata_dir)[1].split('.')[0]+'_SRN_fine-tuning'
    ...
    input_imagepredict3=input_imagepredict3[gap*bin:img_size[0] * bin-gap*bin,gap*bin:img_size[1] * bin-gap*bin]
    ...
    input_imagepredictJPGE = cv2.applyColorMap(input_imagepredictJPGE, 11)
